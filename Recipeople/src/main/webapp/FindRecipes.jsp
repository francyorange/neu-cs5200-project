    ...
    <table border="1">
        ...
        <c:forEach items="${recipes}" var="recipe">
            <tr>
                ...
                <td><c:out value="${recipe.minutes}" /></td>
                <td><c:out value="${recipe.steps}" /></td>
                <td><c:out value="${recipe.description}" /></td>
                <td><fmt:formatDate value="${recipe.submittedAt}" pattern="MM-dd-yyyy hh:mm:ss" /></td>
                <td><c:out value="${recipe.user.userId}" /></td>
